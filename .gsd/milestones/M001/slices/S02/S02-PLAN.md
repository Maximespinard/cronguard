...
- [ ] **T01: Extract shared cron utilities** `est:15m`
...
- [ ] **T02: Alert channel CRUD + monitor association** `est:35m`
...
- [ ] **T03: Miss detection scheduler** `est:45m`
...
- [ ] **T04: Alert dispatch (Resend, Slack, Discord, webhook)** `est:45m`
...
- [ ] **T05: Recovery alerts + integration tests** `est:30m`
